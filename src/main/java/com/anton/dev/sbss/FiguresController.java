...
public class FiguresController {
    ...
    public ResponseEntity<SumEntity> sum(@RequestParam(value = "first", defaultValue = "0") int first, @RequestParam(value = "second", defaultValue = "0") int second) {
    ...
    public ResponseEntity<SubtractEntity> subtract(@RequestParam(value = "first", defaultValue = "0") int first, @RequestParam(value = "second", defaultValue = "0") int second) {
    ...
    public ResponseEntity<MultiplyEntity> multiply(@RequestParam(value = "first", defaultValue = "0") int first, @RequestParam(value = "second", defaultValue = "0") int second) {
